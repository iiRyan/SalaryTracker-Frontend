...
export function colors(category, amount) {
  ...
  if (category === "needs") return "rgba(54, 162, 235, 0.8)"; // Darker Blue for high expenses
  if (category === "wants") return "rgba(255, 99, 132, 0.8)"; // Darker Red for high expenses
  if (category === "savings") return "rgba(255, 205, 86, 0.8)"; // Darker Yellow for high savings
}
